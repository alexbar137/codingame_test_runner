...
class TestGenericSettingsReaderFactory(TestCase):
  ...
  @patch('bin.file_helpers.json_test_case_reader.JsonTestCaseReader.__init__', return_value=None)
  @patch('bin.file_helpers.yaml_config_reader.YamlConfigReader.__init__', return_value=None)
